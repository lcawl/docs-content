...
* [**Rule Retriever**](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-search#operation-search-body-application-json-retriever). Applies [query rules](asciidocalypse://docs/elasticsearch/docs/reference/elasticsearch/rest-apis/searching-with-query-rules.md#query-rules) to the query before returning results.
